        ...
        <div className="container-page grid items-center gap-10 lg:grid-cols-[1fr_0.95fr]">
          <div className="fade-in-up">
            <div className="hero-logo-wrap">
              <BrandLogo brandName={t("common.brandName")} size="lg" showName={false} animated />
            </div>
          ...
          <div className="dashboard-preview-animate space-y-5">
            <Image
              ...
              height={1000}
              priority
              className="aspect-[16/10] w-full rounded-lg border border-[var(--line)] bg-white object-cover shadow-[var(--shadow)]"
            />
            <DashboardPreview
